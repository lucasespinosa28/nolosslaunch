 ...
 */
contract StakedUSDe is SingleAdminAccessControl, ERC20Permit, ERC4626, IStakedUSDe {
   ...
   */
  function transferInRewards(uint256 amount) external onlyRole(REWARDER_ROLE) notZero(amount) {
