...
import {RefundableToken} from "../src/RefundableToken.sol";
...
contract RefundableTokenFactoryTest is Test {
    RefundableTokenFactory public factory;
    ...
    function setUp() public {
        ...
        factory = new RefundableTokenFactory(address(usdeToken), address(stakedUsdeV2));
    }
    ...
    function testCreateLaunchpad() public {
        ...
        RefundableToken launchpad = RefundableToken(launchpadAddress);
    ...
    function testLaunchpadCreatedEvent() public {
        bytes memory bytecode = type(RefundableToken).creationCode;
